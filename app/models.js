...
var cms_models = require("currentcms/lib/models");
  ...
  Artist: {
    ...
    form: [
      {begin: "row"},
        ...
        {end: "col" },
        {begin: "col", options: {className: "two-col"}},
          {name: "work", widget: "choose_create", options: {type: "Artwork", array: true}},
        {end: "col" },
      {end: "row"}
    ]
  },
      ...
      {begin: "row"},
        {begin: "col", options: {className: "two-col"}},
          { name: "images",
            ...
            options: { type: "Artwork", array: true } },
        {end: "col" },
        {begin: "col", options: {className: "two-col"}},
